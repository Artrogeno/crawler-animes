...
import MangaChapterAction from '@src/shared/stores/ducks/mangaChapter'
import MangaChaptersAction from '@src/shared/stores/ducks/mangaChapters'
import HeaderAction from '@src/shared/stores/ducks/header'
import ReadControl from '@src/shared/components/ReadControl'
...
const MangaChapter = props => {
  ...
  useEffect(() => {
    ...
    dispatchHeader()
  }, [t, history, dataGateway, dispatch])
